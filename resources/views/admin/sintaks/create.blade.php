...
@section('title', 'Create Code Block')

@section('content')
<div class="container-fluid">
    <h1 class="h3 mb-3 text-gray-800">Create Code Block</h1>

    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('code-blocks.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="code_content" id="code_content" class="form-control @error('code_content') is-invalid @enderror" rows="15">{{ old('code_content') }}</textarea>
                    @error('code_content')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">Save Code Block</button>
